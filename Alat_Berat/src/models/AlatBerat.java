...
public class AlatBerat extends Database {
    // Constructor untuk Connect ke Database
    public AlatBerat() throws ClassNotFoundException, SQLException {
        super();
    }

    // Create
    public void insert(String nama, String jenis, int harga) throws SQLException {
        String sql = String.format("INSERT INTO alatberat (merk, jenis, harga) VALUE ('%s', '%s', %d)", nama, jenis,
                harga);
        this.setQuery(sql);
        this.execute();
    }
    ...
    public void getAll() throws SQLException {
        String sql = "SELECT * FROM alatberat";
        this.setQuery(sql);
        this.take();
    }
    ...
    public void update(int id, String merk, String jenis, int harga) throws SQLException {
        String sql = String.format("UPDATE alatberat SET merk = '%s', jenis = '%s', harga = %d WHERE id = %d",
                merk, jenis, harga, id);
        this.setQuery(sql);
        this.execute();
    }
    ...
    public void delete(int id) throws SQLException {
        String sql = String.format("DELETE FROM alatberat WHERE id = %d", id);
        this.setQuery(sql);
        this.execute();
    }
